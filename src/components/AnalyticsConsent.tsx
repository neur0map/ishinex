          ...
          <DialogHeader>
            <div className="flex items-center gap-3 mb-2">
              ...
              <DialogTitle className="text-2xl">
                Help Improve ishinex
              </DialogTitle>
            </div>
            <DialogDescription className="text-base mt-2">
              We'd like to collect anonymous usage data to improve your
              experience.
            </DialogDescription>
          </DialogHeader>
        </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4">
            <div className="flex gap-2 items-start">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                This data helps us understand which features are most valuable,
                identify performance issues, and prioritize improvements. Your
                choice won't affect any functionality.
              </p>
            </div>
          </div>
        </div>
          ...
          <Card className="p-4 shadow-lg border-purple-200 dark:border-purple-800">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2 flex-1">
                <p className="text-sm font-medium">Help improve ishinex</p>
                <p className="text-xs text-gray-600 dark:text-gray-400">
                  We collect anonymous usage data to improve your experience. No
