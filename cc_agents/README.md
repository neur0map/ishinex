...
<div align="center">
  <p>
    <strong>Pre-built AI agents for ishinex powered by Claude Code</strong>
  </p>
  <p>
...
1. In ishinex, navigate to **CC Agents**
...
1. Download a `.ishinex.json` file from this repository
2. In ishinex, navigate to **CC Agents**
3. Click the **Import** dropdown button
4. Select **From File**
5. Choose the downloaded `.ishinex.json` file
...
4. Choose where to save the `.ishinex.json` file

### Agent File Format

All agents are stored in `.ishinex.json` format with the following structure:
...
### 1. Create Your Agent
Design and test your agent in ishinex with a clear, focused purpose.

### 2. Export Your Agent
Export your agent to a `.ishinex.json` file with a descriptive name.

### 3. Submit a Pull Request
1. Fork this repository
2. Add your `.ishinex.json` file to the `cc_agents` directory
...
These agents are provided under the same license as the ishinex project. See the main LICENSE file for details.

---

<div align="center">
  <strong>Built with ❤️ by the ishinex community</strong>
</div> 
